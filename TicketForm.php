...
<div class="">
    <div class="container">
        <form action="TicketResult.php" method="post">
            ...
            <label for="itemQuantity">Quantity of Ticket:</label>
            ...
            <div id="sub">
                ...
                <button id="cancelBtn" type="button" class="btn btn-danger" onclick="window.location.href='index.php'">Cancel</button>
            </div>
